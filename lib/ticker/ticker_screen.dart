...
import 'package:turing_deal/ticker/analysis/turing_deal_analysis.dart';
        ...
        builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
          return SafeArea(
            child: Scaffold(
              appBar: AppBar(
                  title: Text(
                      TickerResolve.getTickerDescription(this.widget.ticker))),
                  ...
                  : Container(
                      ...
                      child: PageView(
                        ...
                        children: [
                          ...
                          TuringDealAnalysis(
                              snapshot.data as List<CandlePrice>),
                          ListPricesText((snapshot.data as List<CandlePrice>)
                              .reversed
                              .toList())
                        ],
                      )),
              bottomNavigationBar: BottomNavigationBar(
                ...
                items: [
                  ...
                  BottomNavigationBarItem(
                      ...
                      label: 'Analysis'.tr),
                  BottomNavigationBarItem(
                      icon: Icon(Icons.list), label: 'Prices'.tr),
                ],
              ),
            ),
          );
