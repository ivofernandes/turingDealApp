    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          searchingWidget,
          suggestion(
              const Icon(Icons.view_headline), 'Main'.t, TickersList.main),
          suggestion(const Icon(Icons.precision_manufacturing_outlined),
              'Sectors'.t, TickersList.sectors),
          suggestion(const Icon(Icons.workspaces_outline), 'Futures'.t,
              TickersList.futures),
          suggestion(const Icon(Icons.computer), 'Cryptos'.t,
              TickersList.cryptoCurrencies),
          suggestion(
              const Icon(Icons.language), 'Countries'.t, TickersList.countries),
          suggestion(const Icon(Icons.account_balance_outlined), 'Bonds',
              TickersList.bonds),
          suggestion(const Icon(Icons.architecture_sharp), 'Sizes'.t,
              TickersList.sizes),
          suggestion(const Icon(Icons.business_sharp), 'Companies'.t,
