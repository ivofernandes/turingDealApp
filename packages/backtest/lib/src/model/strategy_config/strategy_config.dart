...
class StrategyConfig {
  ...
  @override
  String toString() =>
      'StrategyConfig{name: $name, direction: $direction, target: $target, stopLimit: $stopLimit, trailingStopLimit: $trailingStopLimit, trailingStopStep: $trailingStopStep, openningRules: $openningRules, closingRules: $closingRules}';
}
