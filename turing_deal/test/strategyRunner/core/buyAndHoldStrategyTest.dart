...
void main() {
  test('Test buy and hold strategy', () async {
    List<CandlePrices> prices = [
      CandlePrices(date: DateTime(2020, 1, 1), volume: 1, open: 1, close: 1, high: 1, low: 1),
      CandlePrices(date: DateTime(2020, 3, 1), volume: 1, open: 1, close: 1, high: 1, low: 0.5),
      CandlePrices(date: DateTime(2020, 6, 1), volume: 1, open: 1, close: 1, high: 2, low: 1.5),
      CandlePrices(date: DateTime(2020, 12, 31), volume: 1, open: 2, close: 2, high: 2, low: 2),
    ];

    StrategyResult strategy = BuyAndHoldStrategy.buyAndHoldAnalysis(prices);
